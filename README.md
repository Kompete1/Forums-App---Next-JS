...
## Status
- Current milestone: `Moderator/Admin Thread Pinning PR42` implementation wave.
...
3. Execute from the relevant current ExecPlan in `plans/` (latest: `plans/pr42-v6-thread-pinning-execplan.md`).
